            ...
            {filteredAssistants.map((assistant) => {
              ...
              return (
                <button
                  ...
                  className={`group flex w-full items-center justify-between rounded-2xl  px-2.5 py-2 text-left transition-all duration-200 ${
                    isActive
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                  {nodes.map((n, i) => (
                    <React.Fragment key={i}>
                      <span
                        className={`rounded-[4px] px-2.5 py-1 text-[10px] font-medium transition-all duration-200  ${
                          i === nodes.length - 1
